...
/*
This was taken from https://github.com/kokke/tiny-bignum-c with a public domain license
Thanks! :)
*/
...
void bignum_to_string(struct bn* n, char* str, int maxsize, bool leading_zeros);
...
void bignum_endian_swap(struct bn* n);                     /* In place endiam swap on n */
